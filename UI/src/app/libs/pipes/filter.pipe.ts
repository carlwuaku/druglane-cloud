...
export class FilterPipe implements PipeTransform {
  ...
  /**
   * Searches an array of objects for a given search text. If no search text
   * is provided, the original array is returned. If no properties are
   * specified, all properties of each object are searched. If properties
   * are specified, only those properties are searched.
   *
   * @param items The array of objects to search
   * @param searchText The text to search for
   * @param properties An optional array of property names to search
   * @returns A new array containing only the objects that match the search text
   */
